...
2. SSO checks `accounts_session` cookie → redirects to login if not authenticated
3. User logs in → SSO issues auth code → redirects back to your app's callback URL
